@echo off
REM Fully Automated Deployment Using Token Directly
REM No interactive login needed!

echo ============================================================
echo   CEDOS Backend - Fully Automated Railway Deployment
echo ============================================================
echo.
...
set RAILWAY_TOKEN=c87c4dea-c118-4afb-9db6-e323a68ff5d2
set RAILWAY_API_TOKEN=c87c4dea-c118-4afb-9db6-e323a68ff5d2
...
echo [STEP 4] Enter your Supabase password:
...
if %errorlevel% neq 0 (
    echo [INFO] Project might already exist, continuing...
)
